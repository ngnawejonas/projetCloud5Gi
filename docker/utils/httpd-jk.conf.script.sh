...
</IfModule>" > httpd-jk.conf

#copy to apache server
cat httpd-jk.conf|sudo docker exec -i enspy_apache_server sh -c "cat > /etc/libapache2-mod-jk/httpd-jk.conf"
